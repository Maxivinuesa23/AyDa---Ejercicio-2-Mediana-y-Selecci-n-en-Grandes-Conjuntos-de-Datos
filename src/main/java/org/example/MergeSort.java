...
public class MergeSort {
    public ArrayList<Integer> sort(ArrayList<Integer> arr, int left, int right) {
        if(left < right){
    ...
    public void merge(ArrayList<Integer> arr, int left, int middle, int right) {
        ...
        for (int j=0; j < n2; j++) {
            rightArray[j] = arr.get(middle + j + 1);
        }
